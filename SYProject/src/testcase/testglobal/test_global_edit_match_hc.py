...
class Global_Edit_Match_HC(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.path = gl.base + '/api/global-platform-extend/national/sku/consumablesRelation/edit'
        self.body = {"id":1,"specificationCode":"[\"hc23476152\"]"}

    def tearDown(self):
        self.log.logger.info("测试用例执行完之后的收尾操作=====")

    def test_edit_match_hc(self):
