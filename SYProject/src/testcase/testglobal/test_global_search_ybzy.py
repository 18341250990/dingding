...
class Global_Search_YBZY(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.path = gl.base + '/api/global-platform-extend/national/sku/chineseMedicine/list/?offset=0&pagesize=50&piecesName='

    def tearDown(self):
        self.log.logger.info("测试用例执行完之后的收尾操作=====")

    def test_Search_YBZY(self):
