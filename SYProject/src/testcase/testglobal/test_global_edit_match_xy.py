...
class Global_Edit_Match_XY(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.path = gl.base + '/api/global-platform-extend/national/sku/drugsRelation/edit'
        self.body = {"id":1,"goodsCode":"[\"xy23476152\"]"}

    def tearDown(self):
        self.log.logger.info("测试用例执行完之后的收尾操作=====")

    def test_edit_match_xy(self):
