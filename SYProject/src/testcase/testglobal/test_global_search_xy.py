...
class Global_Search_XY(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.path = gl.base + '/api/global-platform-extend/national/sku/drugsRelation/list?offset=0&pagesize=50&tenantName=&status='

    def tearDown(self):
        self.log.logger.info("测试用例执行完之后的收尾操作=====")

    def test_Search_XY(self):
