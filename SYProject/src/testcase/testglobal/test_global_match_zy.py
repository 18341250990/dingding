...
class Global_Match_ZY(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.path = gl.base + '/api/global-platform-extend/national/sku/chineseMedicineRelation/matchingData'
        self.body = {}

    def tearDown(self):
        self.log.logger.info("测试用例执行完之后的收尾操作=====")

    def test_match_zy(self):
