...
class Global_Search_YBXY(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.path = gl.base + '/api/global-platform-extend/national/sku/drugs/list/?offset=0&pagesize=50&registerName=&approvalCode='

    def tearDown(self):
        self.log.logger.info("测试用例执行完之后的收尾操作=====")

    def test_Search_YBXY(self):
